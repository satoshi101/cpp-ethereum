...
{
    (void)_hostProtocolVersion;
    (void)_hostNetworkId;
    (void)_chainTotalDifficulty;
    (void)_chainCurrentHash;
    (void)_chainGenesisHash;
    (void)_snapshotBlockHash;
    (void)_snapshotBlockNumber;
    //RLPStream s;
...
//    auto s = session();
    ...
    if (1 && (now - m_lastAsk > 10 && m_asking != Asking::Nothing))
    {
        // timeout
